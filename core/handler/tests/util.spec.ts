...
describe('#parseWalletUA', () => {
  describe('#android', () => {
    test('should parse "User-Agent: okhttp/3.12.2 (Linux; U; LGE Build/Nexus5)" correctly', () => {
      const wallet = parseWalletUA('User-Agent: okhttp/3.12.2 (Linux; U; LGE Build/Nexus5)');
      expect(wallet).toEqual({ os: '', version: '', jwt: '1.0.0' });
    });

    test('should parse "User-Agent: okhttp/3.12.2 ArcWallet/ (Linux; U; Android 25; LGE Build/Nexus5)" correctly', () => {
    ...
    test('should parse "User-Agent: okhttp/3.12.2 ArcWallet/1.3.62 (Linux; U; Android 25; LGE Build/Nexus5)" correctly', () => {
    ...
    test('should parse "User-Agent: okhttp/3.12.2 ArcWallet/2.7.17 (Linux; U; Android 25; LGE Build/Nexus5)" correctly', () => {
      const wallet = parseWalletUA(
  ...
  describe('#ios', () => {
    test('should parse "iPhone12,3 iOS/13.0 CFNetwork/1098.7" correctly', () => {
      const wallet = parseWalletUA('iPhone12,3 iOS/13.0 CFNetwork/1098.7');
      expect(wallet).toEqual({ os: '', version: '', jwt: '1.0.0' });
    });

    test('should parse "ArcWallet/ iPhone12,3 iOS/13.0 CFNetwork/1098.7 Darwin/19.0.0" correctly', () => {
    ...
    test('should parse "ArcWallet/1.3.29 iPhone12,3 iOS/13.0 CFNetwork/1098.7 Darwin/19.0.0" correctly', () => {
    ...
    test('should parse "ArcWallet/2.7.2 iPhone12,3 iOS/13.0 CFNetwork/1098.7 Darwin/19.0.0" correctly', () => {
  ...
  describe('#web', () => {
    test('should parse "ArcWallet/0.5.0"', () => {
...
describe('getStepChallenge', () => {
  test('should return random bytes', () => {
