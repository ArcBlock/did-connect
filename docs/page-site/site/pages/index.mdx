  ...
  - name: SectionBlock
    ...
    description:
      - name: div
        ...
        children: Open protocols and development SDK for connecting users and decentralized applications designed and implemented based on the W3C DID standard
      - name: div
        className: text-center
        children:
          name: Button
