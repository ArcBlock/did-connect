# [**@did-connect/storage-keystone**](https://github.com/ArcBlock/did-connect)

[![styled with prettier](https://img.shields.io/badge/styled_with-prettier-ff69b4.svg)](https://github.com/prettier/prettier)

> Storage engine that uses keystone.js to store data, implements interfaces defined in `@did-connect/storage`.
...
```sh
npm install @did-connect/storage-keystone keystone
// or
yarn add @did-connect/storage-keystone keystone
```
...
```js
const KeystoneStorage = require('@did-connect/storage-keystone');
